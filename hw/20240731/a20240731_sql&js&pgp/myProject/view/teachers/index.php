...
<nav class="navbar navbar-expand-sm bg-dark navbar-light">
        <div class="container-fluid">
            <ul class="navbar-nav">
                <li class="nav-item">
                <a href=http://localhost/RWD-SN1/a20240731/myProject/view/teachers/index.php class="nav-link text-white">teachers</a>
                </li>
                <li class="nav-item">
                <a href=http://localhost/RWD-SN1/a20240731/myProject/view/student/index.php class="nav-link text-white">studemt</a>
                </li>
            </ul>
        </div>
    </nav>
                ...
                <?php foreach ($data as $key => $value) : ?>
                    ...
                    <tr>
                        ...
                        <td class="text-start">
                            ...
                            <a class="btn btn-danger" href="../../api2/teacher/del.php?id=<?= $value['id']; ?>">Del</a>
